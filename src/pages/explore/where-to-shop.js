...
const IndexPage = (props, {data}) => (
  <Layout>
    <SEO title="Where To Shop In The Cook Islands" />
    <h1 className="text-center">Where To Shop In The Cook Islands</h1>
...
export const pageQuery = graphql`
  query {
    ...
    latestEpisodes: allMarkdownRemark(
      ...
      filter: {frontmatter: {categorySlug: {eq: "where-to-shop/"}}
      }) {
      edges {
        node {
          id
    ...
    allStrapiPodcast(filter: {category: {name: {eq: "where-to-shop"}}}) {
      nodes {
        id
        strapiId
        slug
